...
class Show extends Component {
    ...
    getBusinessFromWindow = () => {
       ...
       fetch(`https://open-carre-backend.herokuapp.com/${businessId}`)
    ...
    handleClaim = () => {
     ...
     fetch('https://open-carre-backend.herokuapp.com/claimBusiness', {
        method: 'PATCH', // or 'PUT'
        headers: {
    ...
    handleFollow = () => {
        ...
        fetch('https://open-carre-backend.herokuapp.com/followBusiness', {
            method: 'post', // or 'PUT'
            headers: {
                'Content-Type': 'application/json',
            },
